...
public class DbContract {
    ...
    public static final String SERVER_URL_SYNCBILL = "http://10.0.130.100/MoneyManager/money_management/sync_bill.php/";
    public static final String SERVER_URL_SYNCCATEGORY = "http://10.0.130.100/MoneyManager/money_management/sync_category.php/";
    public static final String SERVER_URL_SYNCPROFILE = "http://10.0.130.100/MoneyManager//money_management/sync_profile.php/";
    public static final String SERVER_URL_GETDATABASE = "http://10.0.130.100/MoneyManager/money_management/getDatabase.php/";
