...
public class DbContract {
    ...
    public static final String SERVER_URL_SYNCBILL = "http://192.168.1.13/MoneyManager/money_management/sync_bill.php/";
    public static final String SERVER_URL_SYNCCATEGORY = "http://192.168.1.13/MoneyManager/money_management/sync_category.php/";
    public static final String SERVER_URL_SYNCPROFILE = "http://192.168.1.13/MoneyManager//money_management/sync_profile.php/";
    public static final String SERVER_URL_GETDATABASE = "http://192.168.1.13/MoneyManager/money_management/getDatabase.php/";
