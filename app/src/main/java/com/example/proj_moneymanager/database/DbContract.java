...
public class DbContract {
    ...
    public static final String SERVER_URL_SYNCBILL = "http://172.16.1.237/money_management/sync_bill.php/";
    public static final String SERVER_URL_SYNCCATEGORY = "http://172.16.1.237/money_management/sync_category.php/";
    public static final String SERVER_URL_GETDATABASE = "http://172.16.1.237/money_management/getDatabase.php/";
