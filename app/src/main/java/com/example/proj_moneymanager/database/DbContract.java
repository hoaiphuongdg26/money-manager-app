...
public class DbContract {
    ...
    public static final String SERVER_URL_SYNCBILL = "http://172.16.3.109/MoneyManager/money_management/sync_bill.php/";
    public static final String SERVER_URL_SYNCCATEGORY = "http://172.16.3.109/MoneyManager/money_management/sync_category.php/";
    public static final String SERVER_URL_SYNCPROFILE = "http://172.16.3.109/MoneyManager//money_management/sync_profile.php/";
    public static final String SERVER_URL_GETDATABASE = "http://172.16.3.109/MoneyManager/money_management/getDatabase.php/";
